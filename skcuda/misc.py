...
try:
    from . import magma
    print('PMB: Imported MAGMA in skcuda.misc')
    _has_magma = True
except (ImportError, OSError):
    _has_magma = False
...
#    from . import smegma
#    _has_smegma = True
#    print('PMB: Imported SMEGMA in skcuda.misc')
#except (ImportError, OSError):
#    print('Did not import smegma libs')
#    _has_smegma = False
...
# PMB changed np.typeDict to np.sctypeDict
