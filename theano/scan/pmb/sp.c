...
#define CYTHON_FORMAT_SSIZE_T "z"
  ...
  #define __Pyx_PyCode_New(a, k, l, s, f, code, c, n, v, fv, cell, fn, name, fline, lnos)\
          PyCode_New(a, k, l, s, f, code, c, n, v, fv, cell, fn, name, __pyx_empty_tuple,fline, lnos, __pyx_empty_tuple)
 ...
 */
#ifdef PMB
  __pyx_t_3 = ((PyObject *)( (PyArrayObject_fields*)__pyx_v_self)->descr); 
#else
 ...
 */
#ifdef PMB
  Py_XDECREF(((PyArrayObject_fields * )__pyx_v_arr)->base);
#else
  PMB Py_XDECREF(__pyx_v_arr->base);
#endif
 ...
 */
#ifdef PMB
  ( (PyArrayObject_fields * )__pyx_v_arr)->base = __pyx_v_baseptr;
#else
 ...
 */
#ifdef PMB
  __pyx_t_1 = ((((PyArrayObject_fields *)__pyx_v_arr)->base == NULL) != 0);
#else
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
#ifdef PMB
    __Pyx_INCREF(((PyObject *)( (PyArrayObject_fields *) __pyx_v_arr)->base));
    __pyx_r = ((PyObject *)( (PyArrayObject_fields *) __pyx_v_arr)->base);
#else
