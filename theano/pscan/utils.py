...
from theano.graph.type import HasDataType
from theano.graph.utils import TestValueError
from theano.tensor.basic import AllocEmpty, cast
from theano.tensor.subtensor import set_subtensor
from theano.tensor.variable import TensorConstant


if TYPE_CHECKING:
    from theano.scan.op import ScanInfo
...
class ScanArgs:
    ...
    def var_mappings(self):
        from theano.scan.op import ScanMethodsMixin
