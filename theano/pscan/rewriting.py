...
import theano
from theano import scalar as ps
...
from theano.graph.features import ReplaceValidate
from theano.graph.fg import FunctionGraph
from theano.graph.op import compute_test_value
from theano.graph.replace import clone_replace
from theano.graph.rewriting.basic import (
    GraphRewriter,
    copy_stack_trace,
    in2out,
    node_rewriter,
)
from theano.graph.rewriting.db import EquilibriumDB, SequenceDB
from theano.graph.rewriting.utils import get_clients_at_depth
from theano.graph.type import HasShape
from theano.graph.utils import InconsistencyError
from theano.raise_op import Assert
from theano.scalar import ScalarConstant
from theano.scan.op import Scan, ScanInfo
...
from theano.tensor.rewriting.basic import constant_folding, local_useless_switch
from theano.tensor.rewriting.elemwise import local_upcast_elemwise_constant_inputs
from theano.tensor.rewriting.math import local_abs_merge, local_mul_switch_sink
...
from theano.tensor.variable import TensorConstant, get_unique_constant_value
...
def scan_push_out_non_seq(fgraph, node):
    ...
    for nd in local_fgraph_topo:
        if (  # we haven't already looked at this node
            ...
            and not isinstance(nd.op, theano.compile.ViewOp)
