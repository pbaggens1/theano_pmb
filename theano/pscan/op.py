...
import theano
import theano.link.utils as link_utils
from theano import tensor as pt
from theano.compile.builders import construct_nominal_fgraph, infer_shape
from theano.compile.function.pfunc import pfunc
from theano.compile.io import In, Out
from theano.compile.mode import Mode, get_default_mode, get_mode
from theano.compile.profiling import register_profiler_printer
...
from theano.graph.features import NoOutputFromInplace
from theano.graph.op import HasInnerGraph, Op
from theano.graph.replace import clone_replace
from theano.graph.utils import InconsistencyError, MissingInputError
from theano.link.c.basic import CLinker
from theano.link.c.exceptions import MissingGXX
from theano.printing import op_debug_information
from theano.scan.utils import ScanProfileStats, Validator, forced_replace, safe_new
...
from theano.tensor.variable import TensorVariable
...
class Scan(Op, ScanMethodsMixin, HasInnerGraph):
    ...
    def __init__(
        ...
        mode
            ...
            `theano.function` for details about possible values and their meaning).
        typeConstructor
        ...
        allow_gc
            ...
            `theano.config.scan__allow_gc`.

            The full `Scan` behavior related to allocation is determined by this
            value and the flag `theano.config.allow_gc`. If the flag
            ...
            flag `theano.config.allow_gc` means.
        strict
    ...
    def make_thunk(self, node, storage_map, compute_map, no_recycling, impl=None):
        ...
        try:
            ...
            from theano.scan.utils import InnerFunctionError
...
def _op_debug_information_Scan(op: Scan, node: Apply):
    ...
    from theano.scan.utils import ScanArgs
