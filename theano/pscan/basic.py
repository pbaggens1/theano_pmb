...
import theano.tensor as pt
from theano.compile.function.pfunc import construct_pfunc_ins_and_outs
from theano.compile.sharedvalue import SharedVariable, collect_new_shareds
...
from theano.graph.utils import MissingInputError, TestValueError
from theano.scan.op import Scan, ScanInfo
from theano.scan.utils import expand_empty, safe_new, until
from theano.tensor.basic import get_underlying_scalar_constant_value
from theano.tensor.exceptions import NotScalarConstantError
from theano.tensor.math import minimum
from theano.tensor.shape import shape_padleft, unbroadcast
...
def scan(
    ...
    tuple
        ...
        This ``dict`` should be passed to `theano.function` when you compile
        your function.
