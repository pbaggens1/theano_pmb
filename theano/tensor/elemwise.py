    ...
    def _c_all(self, node, nodename, inames, onames, sub):
        ...
        if (
            ...
            dtype_%(x)s& %(x)s_i = ((dtype_%(x)s*) PyArray_DATA(%(x)s))[0];
                    ...
                    if self.openmp:
                        # PMB: the "f" was missing in front of this string:
    ...
    def _c_all(self, node, name, inames, onames, sub):
        ...
        if hasattr(self.scalar_op, "identity"):
            ...
            if self.scalar_op == scalar.maximum:
                ...
                elif input.type.dtype.startswith("uint") or input.type.dtype == "bool" or input.type.dtype == "bool_" : # PMB added bool_
            ...
            if self.scalar_op == scalar.minimum:
                ...
                if input.type.dtype in ["float32", "float64"]:
                    identity = "__builtin_inf()"
                elif input.type.dtype == "bool" or input.type.dtype == "bool_" : # PMB added bool_
